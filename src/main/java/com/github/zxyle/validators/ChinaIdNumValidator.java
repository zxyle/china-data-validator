...
import com.github.zxyle.constraints.ChinaIdNum;
...
public class ChinaIdNumValidator implements ConstraintValidator<ChinaIdNum, String> {
    ...
    private static String convertToNewCardNumber(String oldCardNumber) {
        ...
        buf.append(ChinaIdNumValidator.calculateVerifyCode(buf));
        return buf.toString();
    }
